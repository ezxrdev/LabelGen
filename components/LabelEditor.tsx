...
export const LabelEditor: React.FC<LabelEditorProps> = ({
  ...
  const InputGroup = ({ label, id, value, type = "text" }: { label: string, id: keyof LabelData, value: string, type?: string }) => (
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="grid grid-cols-1 gap-4">
            <InputGroup label="Product Name (产品名称)" id="productName" value={data.productName} />
            <div className="grid grid-cols-2 gap-4">
              <InputGroup label="Model (产品型号)" id="productModel" value={data.productModel} />
              <InputGroup label="Production Year" id="productionYear" value={data.productionYear} />
            </div>
          </div>
        </div>
        ...
        <div>
           ...
           <div className="grid grid-cols-2 gap-4">
              <InputGroup label="QC Status (e.g. 合格)" id="qcStatus" value={data.qcStatus} />
              <InputGroup label="QC Date" id="qcDate" value={data.qcDate} />
           </div>
        </div>
        ...
        <div>
           ...
           <div className="space-y-4">
             <InputGroup label="Company Name" id="companyName" value={data.companyName} />
             <InputGroup label="Website URL" id="website" value={data.website} />
             <InputGroup label="Full Address" id="address" value={data.address} />
             <InputGroup label="Email Address" id="email" value={data.email} />
           </div>
        </div>
      </div>
    </div>
